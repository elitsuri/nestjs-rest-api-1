"""
NestJS REST API 1 - Backend API
Production-ready REST API with NestJS, TypeORM, and JWT auth
"""
...
app = FastAPI(
    title="NestJS REST API 1",
    description="Production-ready REST API with NestJS, TypeORM, and JWT auth",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "NestJS REST API 1"}
